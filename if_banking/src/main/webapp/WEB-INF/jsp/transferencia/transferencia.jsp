...
<title>Transferir - IF Banking</title>
...
<body id="page-top">
	...
	<div id="wrapper">
		...
		<ul
			...
			<li class="nav-item"><a class="nav-link"
				href="<c:url value="deposito"/>"> <i
					class="fas fa-fw fa-money-bill-wave"></i> <span>Depositar</span></a></li>
			<!-- Nav Item - Saque -->
			<li class="nav-item"><a class="nav-link"
		...
		<div id="content-wrapper" class="d-flex flex-column">
			...
			<div id="content">
				...
				<div class="container-fluid">
					...
					<!-- Page Heading -->
					<h1 class="h3 mb-4 text-gray-800 text-center">Transferir</h1>
					<div class="row">
						<div class="col-12">
							<form method="post" class="user"
								action="<c:url value="transferencia/transferir"/>">
								<!-- Inicio do Card -->
								<div class="card shadow mb-4 card-novaaposta mx-auto">
											...
											<div
												...
												<div class="cartela ml-3">
													...
													<div class="card-footer">
														...
														<a
															class="btn btn-block btn-icon-split btn-lg mt-3 mb-3 d-flex justify-content-between activeButton"
													...
													<div class="card-footer">
														<h5 class="h5 mt-3 mb-3 text-gray-800 text-center">
															Saldo de:</h5>

														<a id="corrente"
															class="btn btn-block btn-icon-split btn-lg mt-3 mb-3 d-flex justify-content-between"
															onclick="buttonsAcoes(this.id)"> <input type="hidden"
															id="inputCorrente" value=1><span class="text">Conta
																Corrente</span> <span class="icon"> <img class="icones"
																src="./img/corrente.png" alt="corrente">
														</span>
														</a> <a id="poupanca"
															class="btn btn-block btn-icon-split btn-lg mt-3 mb-3 d-flex justify-content-between"
															onclick="buttonsAcoes(this.id)"> <input type="hidden"
															id="inputPoupanca" value=2> <span class="text">Conta
																Poupança</span> <span class="icon"> <img class="icones"
													...
													<div class="card-footer">
														...
														<div class="input-group mt-3 mb-3">
															...
															<input type="text" name="valorTransferencia"
											...
											<div
												...
												<div class="cartela ml-3">
													...
													<div class="card-footer">
														...
														<a id="email"
															class="btn btn-block btn-icon-split btn-lg mt-3 mb-3 d-flex justify-content-between activeButton"
															onclick="buttonsAcoes(this.id)"> <span class="text">Email</span>
															<span class="icon"> <img class="icones"
																src="./img/email.png" alt="email">
														</span>
														</a>
													</div>
													<div class="card-footer">
														...
														<div class="input-group mt-3 mb-3">
															<input type="text" name="emailDestinatario"
																placeholder="Email do Destinatário" class="form-control">
														</div>
													</div>
												</div>
									...
									<div class="card-footer text-center">
										<button type="submit" data-toggle="modal"
											...
											</span> <span class="text">Transferir</span>
										</button>
									</div>
								</div>
								<!-- / Fim do Card-->
	...
	<!-- TransferÃªncia Modal
	<div class="modal fade" id="transferenciaModal" tabindex="-1"
		role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				<div class="modal-header">
					<h5 class="modal-title" id="exampleModalLabel">Transferência
						Realizada Com Sucesso!</h5>
					<button class="close" type="button" data-dismiss="modal"
						aria-label="Close">
						<span aria-hidden="true">X</span>
					</button>
				...
				<div class="modal-footer">
					<a class="btn btn-primary" href="<c:url value="transferencia"/>">Fechar</a>
				</div>
			</div>
		</div>
	</div>-->
