...
<body id="page-top">
		...
		<ul
			...
			<li class="nav-item"><a class="nav-link"
				href="<c:url value="deposito"/>"> <i
					class="fas fa-fw fa-money-check"></i> <span>Depositar</span></a></li>
		...
		<div id="content-wrapper" class="d-flex flex-column">
			...
			<div id="content">
				...
				<div class="container-fluid">
					...
					<!-- Page Heading -->
					<h1 class="h3 mb-4 text-gray-800 text-center">Sacar</h1>
					<div class="row">
						<div class="col-12">
							<form method="post" class="user"
								action="<c:url value="saque/sacar"/>">
								<!-- Inicio do Card -->
										...
										<div class="row">
											<div
												...
												<div class="cartela ml-3">
													...
													<div class="card-footer">
														<h5 class="h5 mt-3 mb-4 text-gray-800 text-center">
															Saldo de:</h5>
														<a id="corrente"
													...
													<div class="card-footer">
														<div class="input-group mt-3 mb-3">
															...
															<input type="text" name="valorSaque"
																onkeyup="somenteNumeros(this)"
																placeholder="Valor do Saque" class="form-control"
											...
											<div class="col-md-6">
												<img class="imagem-novaaposta img-fluid" alt="dinheiro"
													src="./img/cadastrar-fundo.png">
											</div>
										</div>
									</div>
									<div class="card-footer text-center">
										<button type="submit" data-toggle="modal"
											data-target="#saqueModal"
											class="btn btn-primary btn-icon-split btn-lg mt-3 mb-3">
											<span class="icon text-white-50"> <i
												class="fas fa-check"></i>
											</span> <span class="text">Sacar</span>
										</button>
									</div>
								</div>
								<!-- / Fim do Card-->
	...
	<!-- Saque Modal-->
	<div class="modal fade" id="saqueModal" tabindex="-1" role="dialog"
		aria-labelledby="exampleModalLabel" aria-hidden="true">
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				<div class="modal-header">
					<h5 class="modal-title" id="exampleModalLabel">Saque Realizado
						Com Sucesso!</h5>
					<button class="close" type="button" data-dismiss="modal"
						aria-label="Close">
						<span aria-hidden="true">X</span>
				...
				<div class="modal-footer">
					<a class="btn btn-primary" href="<c:url value="saque"/>">Fechar</a>
				</div>
			</div>
		</div>
	</div>
